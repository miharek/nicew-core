...
void NWDataCopyBytes(NWData *_Nonnull data, size_t start, size_t size, uint8_t *_Nonnull output) NW_VISIBILITY_DEFAULT;
...
/// Deletes a block of data created with a `NWDataCreate*` method.
void NWDataDelete(NWData *_Nonnull data) NW_VISIBILITY_DEFAULT;

/// Determines whether NWo data blocks are equal.
