...
Pod::Spec.new do |s|
  s.name         = 'WalletCore'
  s.version      = version
  s.summary      = 'NiceW core data structures and algorithms.'
  s.homepage     = 'https://github.com/miharek/nicew-core'
  s.license      = 'MIT'
  s.authors      = { 'Miha Rek' => 'rek.mihael@gmail.com' }
  ...
  s.source = {
    git: 'git@github.com:miharek/nicew-core.git'
  }
