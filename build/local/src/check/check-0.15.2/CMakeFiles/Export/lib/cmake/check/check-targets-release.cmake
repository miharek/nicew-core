...
set_target_properties(Check::checkShared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcheck.0.15.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcheck.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Check::checkShared )
list(APPEND _IMPORT_CHECK_FILES_FOR_Check::checkShared "${_IMPORT_PREFIX}/lib/libcheck.0.15.2.dylib" )
