...
bool Entry::validateAddress([[maybe_unused]] NWCoinType coin, const string& address, NW::byte, NW::byte, const char*) const {
    return Address::isValid(address);
}

string Entry::normalizeAddress([[maybe_unused]] NWCoinType coin, const string& address) const {
    // normalized with EIP55 checksum
    return Address(address).string();
}

string Entry::deriveAddress([[maybe_unused]] NWCoinType coin, const PublicKey& publicKey, NW::byte, const char*) const {
    return Address(publicKey).string();
}

Data Entry::addressToData([[maybe_unused]] NWCoinType coin, const std::string& address) const {
    const auto addr = Address(address);
    return {addr.bytes.begin(), addr.bytes.end()};
}

void Entry::sign([[maybe_unused]] NWCoinType coin, const NW::Data& dataIn, NW::Data& dataOut) const {
    signTemplate<Signer, Proto::SigningInput>(dataIn, dataOut);
}

string Entry::signJSON([[maybe_unused]] NWCoinType coin, const std::string& json, const Data& key) const {
...
void Entry::compile([[maybe_unused]] NWCoinType coin, const Data& txInputData, const std::vector<Data>& signatures, [[maybe_unused]] const std::vector<PublicKey>& publicKeys, Data& dataOut) const {
...
Data Entry::buildTransactionInput([[maybe_unused]] NWCoinType coinType, [[maybe_unused]] const std::string& from, const std::string& to, const uint256_t& amount, [[maybe_unused]] const std::string& asset, [[maybe_unused]] const std::string& memo, const std::string& chainId) const {
