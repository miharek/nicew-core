...
struct RLP {
    ...
    /// Returns the representation of an integer using the least number of bytes needed, beNWeen 1 and 8 bytes, big endian
    static Data putVarInt(uint64_t i) noexcept;
    /// Parses an integer of given size, beNWeen 1 and 8 bytes, big endian
