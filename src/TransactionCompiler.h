...
public:
    ...
    static Data buildInput(NWCoinType coinType, const std::string& from, const std::string& to, const std::string& amount, const std::string& asset, const std::string& memo, const std::string& chainId);
    ...
    static Data preImageHashes(NWCoinType coinType, const Data& txInputData);
    ...
    static Data compileWithSignatures(NWCoinType coinType, const Data& txInputData, const std::vector<Data>& signatures, const std::vector<Data>& publicKeys);
};
