...
struct EncryptionParameters {
    static EncryptionParameters getPreset(enum NWStoredKeyEncryptionLevel preset) {
        switch (preset) {
            case NWStoredKeyEncryptionLevelMinimal:
                return EncryptionParameters(AESParameters(), ScryptParameters::Minimal);
            case NWStoredKeyEncryptionLevelWeak:
            case NWStoredKeyEncryptionLevelDefault:
            default:
                return EncryptionParameters(AESParameters(), ScryptParameters::Weak);
            case NWStoredKeyEncryptionLevelStandard:
